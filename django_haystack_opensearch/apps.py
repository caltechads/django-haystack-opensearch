...
class DjangohaystackopensearchAppConfig(AppConfig):
    name: str = "django_haystack_opensearch"
    label: str = "django_haystack_opensearch"
    verbose_name = _("django_haystack_opensearch")
