...
2. Checkout your fork: ``git clone https://github.com/your-username/django-haystack-opensearch.git``
...
8. Create a pull request at `<https://github.com/caltechads/django-haystack-opensearch/pulls>`_ and wait for it to be reviewed and merged.
